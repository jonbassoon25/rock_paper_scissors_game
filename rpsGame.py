...
paper_png = pygame.image.load("assets/paper.png")
...
def box(screen, x, y, selected = False):
    ...
    pygame.draw.rect(screen, color, (x - 100, y - 100, 200, 200), 3)
...
def rps_lineup(selection):
    ...
    rock(150, 250)
    display_text("Rock", 100, 350)
    box(screen, 400, 250, select[1])
    paper(400, 250)
    display_text("Paper", 335, 350)
    box(screen, 650, 250, select[2])
    scissors(650, 250)
    display_text("Scissors", 550, 350)
